...
class ApiClient:
    # 类变量定义环境配置
    ENV = "dev"  # 默认环境，可通过 GraphQLClient.ENV = "uat" 动态修改
    DEFAULT_TIMEOUT = 10
    ...
    def base_url(cls) -> str:
        """获取当前环境的基础URL"""
        env_map = {
            "dev": "https://dev-producthub-gca.api.adidas.com.cn/api/pid/pid-backend/graphql",
            "uat": "https://uat-producthub-gca.api.adidas.com.cn/api/pid/pid-backend/graphql",
        }
    ...
    def post(self, endpoint: str = "", json: dict = None, **kwargs) -> requests.Response:
        return self.send_request("POST", endpoint=endpoint, json=json, **kwargs)
